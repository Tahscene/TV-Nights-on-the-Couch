As part of the CSE4204: Computer Graphics Lab final project, our objective is to design and
implement an interactive 3D scene using Three.js. The project must satisfy the following core requirements:
...
In addition to these general requirements, the assigned project includes the following specific
features:
